...
- Jede Systemreaktion ist begruendet: "Warum gerade so?" wird als kurzer Grund + Prognose angezeigt.
...
- **[20.2.3.1 - SIM-WQ1 - Sichtbarkeit der Entscheidungslogik](./2023a_transparenz.md)**
  - Warum schaltet das System im Lab gerade? Schwellen, Prioritaeten, Prognosen zeigen.
...
- Logging-Screen: Grund, Datenbasis, Prognose und naechster Check.
