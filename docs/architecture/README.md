...
* [05 - Bausteinsicht](./05_building_block_view)
  ...
  * [5.2 - Level 2: Die Whitebox (Innenleben)](./05_building_block_view/052_whitebox)
    * [05.2.1 - Whitebox: Core-Orchestrierung](./05_building_block_view/052_whitebox/0521_core_whitebox)
    ...
    * [05.2.2 - Whitebox: Adapter & Feld-I/O](./05_building_block_view/052_whitebox/0522_adapters_whitebox)
    ...
    * [05.2.3 - Whitebox: UI und Explainability](./05_building_block_view/052_whitebox/0523_ui_explain_whitebox)
    ...
    * [05.2.4 - Whitebox: Data und Research](./05_building_block_view/052_whitebox/0524_data_research_whitebox)
    ...
    * [05.2.5 - Whitebox: Operations (Security / Config / Observability)](./05_building_block_view/052_whitebox/0525_operations_whitebox)
